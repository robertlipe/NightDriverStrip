...
public:
    ...
    {
        #if USE_SCREEN
            Serial.print( str_sprintf(">> Launching Screen Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    void StartSerialThread()
    {
            ...
            Serial.print( str_sprintf(">> Launching Serial Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    void StartColorDataThread()
    {
            ...
            Serial.print( str_sprintf(">> Launching ColorData Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        Serial.print( str_sprintf(">> Launching Drawing Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        #if ENABLE_AUDIO
            Serial.print( str_sprintf(">> Launching Audio Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        #if ENABLE_WIFI
            Serial.print( str_sprintf(">> Launching Network Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        #if ENABLE_WIFI
            Serial.print( str_sprintf(">> Launching Debug Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    void StartSocketThread()
    {
            ...
            Serial.print( str_sprintf(">> Launching Socket Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        #if ENABLE_REMOTE
            Serial.print( str_sprintf(">> Launching Remote Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    {
        Serial.print( str_sprintf(">> Launching JSON Writer Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
    ...
    TaskHandle_t StartEffectThread(EffectTaskFunction function, LEDStripEffect* pEffect, const char* name, UBaseType_t priority = NET_PRIORITY, BaseType_t core = NET_CORE)
    {
        ...
        Serial.print( str_sprintf(">> Launching %s Effect Thread.  Mem: %lu, LargestBlk: %lu, PSRAM Free: %lu/%lu, ", name, ESP.getFreeHeap(),ESP.getMaxAllocHeap(), ESP.getFreePsram(), ESP.getPsramSize()) );
