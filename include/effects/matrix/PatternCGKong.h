...
class PatternCGKong : public EffectWithId<PatternCGKong>
{
    ...
    static constexpr uint16_t dkFur[3][12] = {
        ...
        {0x000, 0x8E1, 0x9F1, 0x7FC, 0xFFF, 0x81F, 0x81F, 0x81F, 0xFFF, 0x7FC, 0x666, 0x666}, // Pounding A (Arms out, wide stance)
        {0x9F9, 0xFFF, 0x81F, 0x81F, 0x81F, 0xFFF, 0x7FC, 0x7FC, 0x7FC, 0x3F8, 0x228, 0x666}  // Pounding B (Arms up, wide stance - Feet fixed!)
    };
