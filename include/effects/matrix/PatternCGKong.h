...
class PatternCGKong : public EffectWithId<PatternCGKong>
{
    ...
    static constexpr uint16_t dkFur[3][12] = {
        ...
        {0x1F8, 0x7FE, 0xF07, 0xE07, 0xFFF, 0xFFF, 0x7FE, 0x3FC, 0x3FC, 0x1F8, 0x198, 0x198}, // Pounding A (Arms out, wide stance)
        {0xE07, 0xF0F, 0x7FE, 0x3FC, 0x3FC, 0x7FE, 0x3FC, 0x1F8, 0x1F8, 0x0F0, 0x198, 0x198}  // Pounding B (Arms up, wide stance - Feet fixed!)
    };
    ...
    static constexpr uint16_t dkTan[3][12] = {
        ...
        {0x000, 0x000, 0x070, 0x070, 0x000, 0x0F8, 0x0F8, 0x070, 0x000, 0x000, 0x000, 0x000},
        {0x000, 0x000, 0x070, 0x070, 0x000, 0x0F8, 0x0F8, 0x070, 0x000, 0x000, 0x000, 0x000}
    };
