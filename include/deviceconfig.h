    ...
    GetSettingSpecs()
    {
        if (settingSpecs.empty())
        {
            ...
            settingSpecs.emplace_back(
                ...
                "in the <a href=\"/timezones.json\">timezones.json</a> "
                "file.",
                SettingSpec::SettingType::String);
            settingSpecs.emplace_back(
            ...
            settingSpecs.emplace_back(
                ...
                "after an effect transition, so the device resumes "
                "from the same effect when restarted. Enabling this will "
                "lead to more wear on the flash chip of your device.",
                SettingSpec::SettingType::Boolean);
            settingSpecs
...
// build
            ...
            auto &powerLimitSpec = settingSpecs.emplace_back(
                ...
                "board is allowed to use. As the previous sentence "
                "implies, this "
            ...
            settingSpecs.emplace_back(
                ...
                "combination with the current global color. That palette "
                "is used "
