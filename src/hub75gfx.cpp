...
SMLayerBackground<HUB75GFX::SM_RGB, HUB75GFX::kBackgroundLayerOptions>
    HUB75GFX::backgroundLayer(kMatrixWidth, kMatrixHeight);
SMLayerBackground<HUB75GFX::SM_RGB, HUB75GFX::kBackgroundLayerOptions>
    HUB75GFX::titleLayer(kMatrixWidth, kMatrixHeight);
SmartMatrixHub75Calc<COLOR_DEPTH, HUB75GFX::kMatrixWidth,
                     HUB75GFX::kMatrixHeight, HUB75GFX::kPanelType,
                     HUB75GFX::kMatrixOptions>
    HUB75GFX::matrix;
...
void HUB75GFX::PrepareFrame()
{
    ...
    EVERY_N_MILLIS(MILLIS_PER_FRAME)
    {
        ...
        auto pMatrix = std::static_pointer_cast<HUB75GFX>(
...
void HUB75GFX::PostProcessFrame(uint16_t localPixelsDrawn,
