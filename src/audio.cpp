...
void IRAM_ATTR AudioSamplerTaskEntry(void *)
{
    ...
    // https://github.com/PlummersSoftwareLLC/PETRock which allows you to
    // connect the ESP to the USERPORT of a Commodore 64 or PET (40 or 80
    // cols) and display the spectrum visualization on the computer's
    // screen in assembly language.
    //
    // To support this, when enabled, this task repeatedly sends out
    // copies of the latest data peaks, scaled to 20, which is the max
    // height of the PET/C64 spectrum bar.  This should manage around 24
    // fps at 2400baud.
    //
...
void IRAM_ATTR AudioSerialTaskEntry(void *)
{
    ...
    for (;;)
    {
        ...
        if (Serial2.availableForWrite())
        {
            ...
            /* PETROCK no longer sends these confirmation stars, but we
            could add it back...
