...
void CWebServer::begin()
{
    ...
    debugI("Embedded html file size: %zu", html_file.length);
    debugI("Embedded jsx file size: %zu", js_file.length);
    debugI("Embedded ico file size: %zu", ico_file.length);
    debugI("Embedded timezones file size: %zu", timezones_file.length);
